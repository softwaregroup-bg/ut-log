...
.then(function contextLoaded(context) {
    ...
    b = repl.context.b  = context.bunyan.createLog('trace', {name: 'bunyan log', context: 'bunyan log context'});setTimeout(function(){test()}, 3000);
        ...
        msg = repl.context.msg = {$$:{frame: new Buffer(test)}};
})
